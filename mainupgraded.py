...
def upload_file():
	...
	if request.method == 'POST':
		...
		return render_template('upload2.html', filenames = filelist, line_chart= line_chart, image_name=image_name, selected_algorithm=selected_algorithm, RMSE=RMSE, selected_optimizer= selected_optimizer)
...
def forecast():
	...
	if selected_file == "default":
		#selected_algorithm = " "
		filelist = os.listdir( "data" )
		return render_template('upload2.html', filenames = filelist, line_chart = line_chart, image_name= image_name, selected_algorithm=selected_algorithm, selected_optimizer=selected_optimizer, error = True)
	print(selected_file)
	...
	def lstm(energyData):
		...
		line_chart.add('Actual Energy Demand', y_val_uni)
		line_chart.add('Predicted Energy Demand',  y_pred.flatten() )
